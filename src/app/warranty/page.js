...
//         <h2 className="text-center fw-bold mb-4 mt-4" style={{color:'#f7931e'}}>Warranty Policy</h2>
//         <hr />

//         <h5 className="mt-4 fw-bold" style={{color:'#f7931e'}}>General Warranty and Product Fault Information</h5>
//         <p className='fw-bold fs-6'>Welcome to EBIKE100. Thank you for choosing our products. We are committed to providing high-quality products and reliable after-sales support. This warranty policy outlines the scope of coverage, exclusions, and conditions for warranty service.</p>

//         <h5 className="mt-4 fw-bold" style={{color:'#f7931e'}}>What Is Not Covered Under Warranty?</h5>
//         <p className='fw-bold fs-6'>While we strive to offer comprehensive support, please note that the following are not covered under the warranty:</p>
...
//         <h5 className="mt-4 fw-bold" style={{color:'#f7931e'}}>Warranty Duration</h5>
//         <p className='fw-bold fs-6'>All of our products come with a 12-month warranty from the date of purchase.</p>
...
//         </ul>
//         <h5 className="mt-4 fw-bold" style={{color:'#f7931e'}}>What does this limited warranty not cover?</h5>
//         <p className='fw-bold fs-6'>This Limited Warranty does not cover any problem that is caused by:</p>
//         <ul>
