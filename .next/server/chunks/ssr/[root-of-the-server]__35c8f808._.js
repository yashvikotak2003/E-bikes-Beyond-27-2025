...
//             <small className="text-muted" style={{fontSize:'20px'}}>★ ★ ★ ☆ ☆ (1 Review)</small>
//             <p className="mt-3">
...
//   >
//     <i className="bi bi-plus text-dark" aria-label="add"></i>
//   </button>
...
//   >
//     <i className="bi bi-dash text-dark" aria-label="min"></i>
//   </button>
//               <button className="btn btn-warning"><i className="bi bi-cart text-dark me-2" aria-label="cart"></i>Add to cart</button>
//             </div>
//             {/* <div className="mt-3">
...
//               <p className="text-muted mb-1 mt-3 small">Average Miles</p>
//               <h5 className="text-orange fw-bold">65 Miles</h5>
//             </div>
//           </div>
//           <div className="col">
//             <div className="border rounded py-4 px-2 h-100">
...
//               <h5 className="text-orange fw-bold">52v 20aH</h5>
//             </div>
//           </div>
//           <div className="col">
//             <div className="border rounded py-4 px-2 h-100">
...
//       </div>
//       <div className="container py-5">
//         <h1 className="mb-4 fw-bold">Specifications</h1>
//         <div className="accordion" id="specAccordion">
//           {/* Specifications */}
//           <div className="accordion-item border-0 border-bottom">
//             <h2 className="accordion-header">
//               <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSpecs" aria-expanded="true" aria-controls="collapseSpecs">
//                 Specifications
//               </button>
//             </h2>
//             <div id="collapseSpecs" className="accordion-collapse collapse show" data-bs-parent="#specAccordion">
//               <div className="container py-5">
//         <h1 className="mb-4 fw-bold">Specifications</h1>
//         <div className="accordion" id="specAccordion">
//           {/* Specs Accordion */}
...
//                   <li><strong>Frame:</strong> Stainless Steel (Heavy Duty enhanced)</li>
//                   <li><strong>Fork:</strong> Front Suspension</li>
//                   <li><strong>Tyres:</strong> <strong>F&R Kenda</strong> 20"x <strong>2.5 Tubeless Tyre</strong></li>
//                   <li><strong>Rim:</strong> Aluminium Alloy wheel (matt black color)</li>
//                   <li><strong>Motor:</strong> 200W High Torque Brushless Rear Hub Drive Motor</li>
//                   <li><strong>Saddle:</strong> Large & Soft saddle with Spring and Lock</li>
//                   <li><strong>Brake:</strong> F & R Hydraulic Disc Brake With Power Cut-Off</li>
//                   <li><strong>Gear:</strong> <strong>Bigger Flywheel</strong> Single Speed</li>
//                   <li><strong>Display:</strong> LCD Multi-function</li>
//                   <li><strong>Light:</strong> F & R LED Light</li>
//                   <li><strong>Phone Holder:</strong> With 2.1A Output USB Port</li>
//                   <li><strong>Speed Sensor:</strong> 1:3</li>
//                 </ul>
//               </div> */}
//               <div className="accordion-body">
...
//           <div className="accordion-item border-0 border-bottom">
//             <h2 className="accordion-header">
//               <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePerf" aria-expanded="false" aria-controls="collapsePerf">
//                 Performance
//               </button>
//             </h2>
//             <div id="collapsePerf" className="accordion-collapse collapse" data-bs-parent="#specAccordion">
//               <div className="accordion-body">
//                 <p>Details about performance can go here. (You can update this.)</p>
//               </div>
//             </div>
//           </div>
//           {/* Warranty */}
//           <div className="accordion-item border-0 border-bottom">
//             <h2 className="accordion-header">
//               <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWarranty" aria-expanded="false" aria-controls="collapseWarranty">
//                 Warranty
//               </button>
//             </h2>
//             <div id="collapseWarranty" className="accordion-collapse collapse" data-bs-parent="#specAccordion">
//               <div className="accordion-body">
//                 <p>Warranty info can go here. Example: 1 Year Frame, 6 Months Battery.</p>
//               </div>
//             </div>
//           </div>
//         </div>
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$noop$2d$head$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("title", {
                        children: "Bike Specifications | EBIKE100"
                    }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("meta", {
                        name: "description",
                        content: "Explore e-bike specifications including motor, tyres, and more."
                    }, void 0, false, {
                        fileName: "[project]/src/app/productdetails/page.js",
                        lineNumber: 391,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("link", {
                        rel: "canonical",
                        href: "https://yourdomain.com/specifications"
                    }, void 0, false, {
                        fileName: "[project]/src/app/productdetails/page.js",
                        lineNumber: 392,
                        columnNumber: 9
...
//# sourceMappingURL=%5Broot-of-the-server%5D__35c8f808._.js.map